    ...
    Object.keys(endpoints).forEach(key => {
      ...
      this[key] = async (param, payload) => {
        ...
        if (api.payload && payload) {
          _payload = typeof api.payload.format === 'function' ? api.payload.format(payload) : payload;
          const error = typeof api.payload.validate === 'function' ? api.payload.validate(payload) : false;
